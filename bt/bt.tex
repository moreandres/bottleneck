...
\abstract{Report generated using {\tt bottleneck} version {\tt 0.1}. Please report issues to {\tt more.andres@gmail.com}. Full Log: {\tt mm-full-20130707-090437.log}. Homepage \href{TBD}{http://www.github.com/amore/bottleneck}.}
...
\item range: {\tt @@FIRST@@ - @@LAST@@} seconds % TBD: min, max?
