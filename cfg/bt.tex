...
\abstract{This performance report is intended to support performance analysis and optimization activities. It includes details on program behavior, system configuration and capabilities, and relevant data from well-known performance analysis tools. This report was generated using {\tt bottleneck} version {\tt 0.1}. Homepage \url{http://www.github.com/amore/bottleneck}. Please report issues to \url{mailto:more.andres@gmail.com}. Full Log: \url{run:@@CWD@@/.bt/@@TIMESTAMP@@/bt.log}.}
